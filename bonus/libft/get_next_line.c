...
/*   Updated: 2025/04/02 09:18:57 by hamel-yo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../checker.h"

void	gnl_make_node(t_list **ls, t_list **node, char **buffer, int *fd)
{
...
void	gnl_make_list(t_list **ls, char **buffer, int *fd)
{
	t_list	*save;
	t_list	*node;
	...
	gnl_make_node(ls, &node, buffer, fd);
